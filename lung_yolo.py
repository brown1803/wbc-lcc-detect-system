...
class LungYolo(QThread):
    def __init__(self,imgPath):
        super(LungYolo, self).__init__()
        self.yolo = YOLO("model_file/yolo/lung.pt")
            ...
            for box in boxes:
                ...
                if conf > 0.0:
                    if classes[cls] in classes:
                        ...
                        cv2.putText(img, f"{classes[cls]}", (x+2, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 1)
